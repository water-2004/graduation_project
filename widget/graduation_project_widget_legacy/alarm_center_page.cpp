...
QString SummaryAlertLevel(int critical_count, int new_count) {
    if (critical_count > 0) {
...
void AlarmCenterPage::BuildUi() {
    ...
    summary_label_->setProperty("alertLevel", QStringLiteral("normal"));
    ...
    back_button_->setProperty("buttonRole", QStringLiteral("secondary"));
    ...
    detail_button_->setProperty("buttonRole", QStringLiteral("secondary"));
    confirm_button_ = new QPushButton(QStringLiteral("确认选中报警"), table_group);
    confirm_button_->setProperty("buttonRole", QStringLiteral("primary"));
    auto* export_button = new QPushButton(QStringLiteral("导出 CSV"), table_group);
    export_button->setProperty("buttonRole", QStringLiteral("secondary"));
...
void AlarmCenterPage::UpdateSummaryLabel() {
    ...
    summary_label_->setProperty("alertLevel", SummaryAlertLevel(critical_count, new_count));
    RefreshWidgetStyle(summary_label_);
}
