...
void PatientPage::BuildUi() {
    ...
    refresh_button_->setProperty("buttonRole", QStringLiteral("secondary"));
    delete_button_ = new QPushButton(QStringLiteral("删除病人"), table_group);
    delete_button_->setProperty("buttonRole", QStringLiteral("danger"));
    open_alert_center_button_ = new QPushButton(QStringLiteral("报警中心"), table_group);
    open_alert_center_button_->setProperty("buttonRole", QStringLiteral("secondary"));
    enter_monitor_button_ = new QPushButton(QStringLiteral("进入监测"), table_group);
    enter_monitor_button_->setProperty("buttonRole", QStringLiteral("primary"));
    ...
    export_records_button->setProperty("buttonRole", QStringLiteral("secondary"));
    ...
    confirm_alert_button_->setProperty("buttonRole", QStringLiteral("primary"));
    auto* export_alerts_button = new QPushButton(QStringLiteral("导出 CSV"), alert_group);
    export_alerts_button->setProperty("buttonRole", QStringLiteral("secondary"));
    ...
    add_button_->setProperty("buttonRole", QStringLiteral("primary"));
    update_button_ = new QPushButton(QStringLiteral("更新病人"), editor_group);
    update_button_->setProperty("buttonRole", QStringLiteral("primary"));
    clear_editor_button_ = new QPushButton(QStringLiteral("清空表单"), editor_group);
    clear_editor_button_->setProperty("buttonRole", QStringLiteral("secondary"));
